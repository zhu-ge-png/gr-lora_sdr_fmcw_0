...
class simulator_fmcw(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.label_down = Qt.QLabel("DOWN")
        self.label_down.setStyleSheet("font-weight:600; font-size:14px;")
        self.label_down.setAlignment(QtCore.Qt.AlignLeft)
        self.top_layout.addWidget(self.label_down)
        ...
        self.label_up = Qt.QLabel("UP")
        self.label_up.setStyleSheet("font-weight:600; font-size:14px;")
        self.label_up.setAlignment(QtCore.Qt.AlignLeft)
        self.top_layout.addWidget(self.label_up)
        ...
        self.label_cw = Qt.QLabel("CW")  # 或者写 "FMCW"
        self.label_cw.setStyleSheet("font-weight:600; font-size:14px;")
        self.label_cw.setAlignment(QtCore.Qt.AlignLeft)
        self.top_layout.addWidget(self.label_cw)
