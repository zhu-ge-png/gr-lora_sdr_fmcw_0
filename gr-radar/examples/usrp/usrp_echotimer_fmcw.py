...
class usrp_echotimer_fmcw(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Usrp Echotimer Fmcw", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "usrp_echotimer_fmcw")
        ...
        self._threshold_range = qtgui.Range(-150, 0, 1, -150, 200)
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._rx_gain_range = qtgui.Range(0, 100, 1, 30, 200)
        ...
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._protect_samp_range = qtgui.Range(0, 100, 1, 0, 200)
        ...
        self.top_grid_layout.addWidget(self._protect_samp_win, 1, 1, 1, 1)
        for r in range(1, 2):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._delay_samp_range = qtgui.Range(0, 100, 1, 24, 200)
        self._delay_samp_win = qtgui.RangeWidget(self._delay_samp_range, self.set_delay_samp, "Number delay samples", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.radar_usrp_echotimer_cc_0.set_min_output_buffer(min_out_buffer)
