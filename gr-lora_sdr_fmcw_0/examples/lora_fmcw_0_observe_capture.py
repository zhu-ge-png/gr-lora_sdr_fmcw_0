...
# Title: LoRa FMCW Observe Capture
# Description: Based on lora_fmcw_0_test1, capture true MUX samples and auto-plot on exit.
...
class lora_fmcw_0_observe_capture(gr.top_block):

    def __init__(self):
        gr.top_block.__init__(self, "LoRa FMCW Observe Capture", catch_exceptions=True)
        ...
        self.sps = sps = int((2**sf) * samp_rate / bw)
        self.preamb_len = preamb_len = 8
        self.radar_capture_samples = radar_capture_samples = preamb_len * 2 * sps
        self.capture_out_dir = capture_out_dir = "/tmp"
        self.sync_word = sync_word = 0x12
        self.soft_decoding = soft_decoding = False
        self.radar_capture_path = radar_capture_path = capture_out_dir + "/lora_fmcw_0_observe_capture_radar.dat"
        self.pay_len = pay_len = 255
        self.mux_figure_path = mux_figure_path = capture_out_dir + "/lora_fmcw_0_observe_capture_radar_mux_timefreq.png"
        self.mux_capture_samples = mux_capture_samples = radar_capture_samples + 40000
        self.mux_capture_path = mux_capture_path = capture_out_dir + "/lora_fmcw_0_observe_capture_mux.dat"
        ...
        self.blocks_head_radar_capture_0 = blocks.head(gr.sizeof_gr_complex*1, radar_capture_samples)
        self.blocks_head_mux_capture_0 = blocks.head(gr.sizeof_gr_complex*1, mux_capture_samples)
        self.blocks_file_sink_radar_capture_0 = blocks.file_sink(gr.sizeof_gr_complex*1, radar_capture_path, False)
        self.blocks_file_sink_radar_capture_0.set_unbuffered(True)
        self.blocks_file_sink_mux_capture_0 = blocks.file_sink(gr.sizeof_gr_complex*1, mux_capture_path, False)
        self.blocks_file_sink_mux_capture_0.set_unbuffered(True)
        ...
        self.connect((self.blocks_head_mux_capture_0, 0), (self.blocks_file_sink_mux_capture_0, 0))
        self.connect((self.blocks_head_radar_capture_0, 0), (self.blocks_file_sink_radar_capture_0, 0))
        self.connect((self.blocks_tagged_stream_mux_0, 0), (self.blocks_head_mux_capture_0, 0))
        ...
        self.connect((self.radar_signal_generator_fmcw_c_0, 0), (self.blocks_head_radar_capture_0, 0))
    ...
    def set_bw(self, bw):
        ...
        self.set_sps(int((2**self.sf) * self.samp_rate / self.bw))
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_radar_capture_samples(self.preamb_len * 2 * self.sps)
    ...
    def get_radar_capture_samples(self):
        return self.radar_capture_samples

    def set_radar_capture_samples(self, radar_capture_samples):
        self.radar_capture_samples = radar_capture_samples
        self.set_mux_capture_samples(self.radar_capture_samples + 40000)
        self.blocks_head_radar_capture_0.set_length(self.radar_capture_samples)
    ...
    def set_capture_out_dir(self, capture_out_dir):
        ...
        self.set_radar_capture_path(self.capture_out_dir + "/lora_fmcw_0_observe_capture_radar.dat")
        self.set_mux_capture_path(self.capture_out_dir + "/lora_fmcw_0_observe_capture_mux.dat")
        self.set_mux_figure_path(self.capture_out_dir + "/lora_fmcw_0_observe_capture_radar_mux_timefreq.png")
    ...
    def get_radar_capture_path(self):
        return self.radar_capture_path

    def set_radar_capture_path(self, radar_capture_path):
        self.radar_capture_path = radar_capture_path
        self.blocks_file_sink_radar_capture_0.open(self.radar_capture_path)
    ...
    def get_mux_figure_path(self):
        return self.mux_figure_path

    def set_mux_figure_path(self, mux_figure_path):
        self.mux_figure_path = mux_figure_path

    def get_mux_capture_samples(self):
        return self.mux_capture_samples

    def set_mux_capture_samples(self, mux_capture_samples):
        self.mux_capture_samples = mux_capture_samples
        self.blocks_head_mux_capture_0.set_length(self.mux_capture_samples)

    def get_mux_capture_path(self):
        return self.mux_capture_path

    def set_mux_capture_path(self, mux_capture_path):
        self.mux_capture_path = mux_capture_path
        self.blocks_file_sink_mux_capture_0.open(self.mux_capture_path)
...
def main(top_block_cls=lora_fmcw_0_observe_capture, options=None):
    tb = top_block_cls()
