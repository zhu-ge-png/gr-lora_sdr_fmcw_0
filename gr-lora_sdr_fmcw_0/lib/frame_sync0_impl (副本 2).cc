...
namespace gr
{
    namespace lora_sdr_fmcw_0
    {
        namespace
        {
            ...
            {
                const float up_corr = normalized_corr(in, upchirp, up_energy);
                const float down_corr = normalized_corr(in, downchirp, down_energy);
                                          ...
                                          gr_vector_void_star &output_items)
        {
            ...
            case DETECT:
            {
                ...
                const DetectWindowKind detect_kind = classify_detect_window(
                    in,
                    m_detect_upchirp,
                    m_detect_downchirp,
                    m_detect_up_energy,
