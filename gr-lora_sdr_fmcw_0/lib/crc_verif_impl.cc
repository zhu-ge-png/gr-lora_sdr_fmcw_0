...
#include <gnuradio/lora_sdr_fmcw_0/utilities.h> // for print color
#include "gnuradio/lora_sdr_fmcw_0/crc_verif.h"
                                         ...
                                         gr_vector_void_star &output_items)
        {
            ...
            { // wait for all the payload to come
                ...
                else
                {
                    ...
                    frame_id_tracker::log_rx(message_str, crc_valid != 0);
            ...
            else if ((in_buff.size()>= m_payload_len) && !m_crc_presence)
            {
                ...
                frame_id_tracker::log_rx(message_str, true);
                message_port_pub(pmt::intern("msg"), pmt::mp(message_str));
